...
const support_text='Если Вы не получили ответ, используйте команду /support, затем напишите Ваш вопрос, контактный телефон или адрес электронной почты, специалисты обязательно ответят Вам в кратчайшее время.';
